    ...
    while True:
        ...
        for country in countries:
            ...
            if country_data:
                ...
                # Create the final data structure with timestamp first
                ...
                # If no data was found, check if an old file exists and remove it.
...
def scrape_live(loop, inversed, delay, sport):
    """
